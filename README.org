...
sudo update-alternatives --config java (choose java-8-openjdk)
#+end_src

*** Installation
#+begin_src sh
git clone https://github.com/Lozov-Petr/jscert.git
cd jscert
make init
make
python2 runtests.py `cat ./test_data/interesting_tests.txt`
#+end_src
